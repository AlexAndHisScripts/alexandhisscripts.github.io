...
function throwOutShittyBrowsers()
{
    ...
    alert('You are using Microsoft Edge, which is an awful, awful browser that does not support the javascript required to load high resolution images without hovering over them. Please upgrade to an actually good browser, like Firefox or Chrome. You *will* have a worse experience on this site if you use Edge, and I am not spending hours making a way to fix it because this is a hobby, not a job, and I have less infuriating things to do with my time.');
    }
